...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        # Step 1: Flatten w to a 1D tensor to use index_select
        x = w.view(-1) # (1, batch_size * n_features)
        
        # Step 2: Select embeddings for each index in the flattened tensor
        x = torch.index_select(self.embeddings, 0, x) # (batch_size, n_features, embed_size)
       
        # Step 3: Flatten the last two dimensions to get (batch_size, n_features * embed_size)
